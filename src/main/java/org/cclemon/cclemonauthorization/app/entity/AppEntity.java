...
public class AppEntity {
	...
	/**
	 * Desc:
	 * Column Name:app_num, Column Type:BIGINT UNSIGNED, Nullable:N
	 */
		@Id
    private String appNum ;
	/**
	 * Desc:
	 * Column Name:app_name, Column Type:VARCHAR, Nullable:N
	 */
    private String appName ;
	/**
	 * Desc:
	 * Column Name:menu_num, Column Type:BIGINT, Nullable:N
	 */
    private BigDecimal menuNum ;
	/**
	 * Desc:e.g. /COA001
	 * Column Name:app_url, Column Type:VARCHAR, Nullable:N
	 */
